...
public class NotificationBadge {
    ...
    public static class HuaweiHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            localBundle.putString("package", App.Companion.getInstance().getApplicationContext().getPackageName());
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                ...
                public void run() {
                    try {
                        App.Companion.getInstance().getApplicationContext().getContentResolver().call(Uri.parse("content://com.huawei.android.launcher.settings/badge/"), "change_badge", null, localBundle);
                    } catch (Exception e) {
        ...
        public void executeBadge(int badgeCount) {
            ...
            if (canResolveBroadcast(intent1) || canResolveBroadcast(intent)) {
                AndroidUtilities.runOnUIThread(new Runnable() {
                    @Override
                    public void run() {
                        App.Companion.getInstance().getApplicationContext().sendBroadcast(intent1);
                        App.Companion.getInstance().getApplicationContext().sendBroadcast(intent);
                    }
                });
            }
    ...
    public static class NovaHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            App.Companion.getInstance().getApplicationContext().getContentResolver().insert(Uri.parse(CONTENT_URI), contentValues);
        }
    ...
    public static class OPPOHomeBader implements Badger {
        ...
        private void executeBadgeByContentProvider(int badgeCount) {
            try {
                ...
                App.Companion.getInstance().getApplicationContext().getContentResolver().call(Uri.parse(PROVIDER_CONTENT_URI), "setAppBadgeCount", null, extras);
    ...
    public static class SamsungHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            ContentResolver contentResolver = App.Companion.getInstance().getApplicationContext().getContentResolver();
            Cursor cursor = null;
            try {
    ...
    public static class SonyHomeBadger implements Badger {
        ...
        private void executeBadgeByContentProvider(int badgeCount) {
            ...
            if (mQueryHandler == null) {
                mQueryHandler = new AsyncQueryHandler(App.Companion.getInstance().getApplicationContext().getApplicationContext().getContentResolver()) {
        ...
        private static boolean sonyBadgeContentProviderExists() {
            ...
            ProviderInfo info = App.Companion.getInstance().getApplicationContext().getPackageManager().resolveContentProvider(SONY_HOME_PROVIDER_NAME, 0);
            if (info != null) {
                exists = true;
            }
            return exists;
    ...
    public static class ZukHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                ...
                public void run() {
                    try {
                        App.Companion.getInstance().getApplicationContext().getContentResolver().call(CONTENT_URI, "setAppBadgeCount", null, extra);
                    } catch (Exception e) {
                    }
                }
            });
    ...
    public static class VivoHomeBadger implements Badger {
        ...
        public void executeBadge(int badgeCount) {
            ...
            intent.putExtra("packageName", App.Companion.getInstance().getApplicationContext().getPackageName());
            intent.putExtra("className", componentName.getClassName());
