...
import kotlinx.android.synthetic.main.phone_apps_terms_activity.*

class PhoneAppsTermsActivity : AppCompatActivity(R.layout.phone_apps_terms_activity) {
    ...
    private fun openNext() {
        startActivity(Intent(this, PhonePrivacyPoliceActivity::class.java))
    }
