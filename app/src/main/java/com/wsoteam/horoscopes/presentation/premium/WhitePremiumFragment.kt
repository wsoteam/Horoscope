...
import kotlinx.android.synthetic.main.white_premium_fragment.*

class WhitePremiumFragment : Fragment(R.layout.white_premium_fragment) {
    ...
    private fun openNextScreen(){
        startActivity(Intent(activity, WhitePaySuccessActivity::class.java))
        activity!!.finish()
    }
}