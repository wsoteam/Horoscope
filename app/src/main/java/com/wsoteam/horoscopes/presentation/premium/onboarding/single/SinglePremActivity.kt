...
import kotlinx.android.synthetic.main.default_premium_activity.*
import kotlinx.android.synthetic.main.single_prem_activity.*
import kotlinx.android.synthetic.main.single_prem_activity.btnPay
import kotlinx.android.synthetic.main.single_prem_activity.tvPrice
...
class SinglePremActivity : AppCompatActivity(R.layout.single_prem_activity) {
    ...
    private fun setPrice() {
        tvPrice.text = "${PreferencesProvider.getPrice()}/month"
    }
