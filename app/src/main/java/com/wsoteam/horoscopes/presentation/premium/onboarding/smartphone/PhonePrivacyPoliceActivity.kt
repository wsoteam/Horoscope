...
import kotlinx.android.synthetic.main.phone_privacy_police.*

class PhonePrivacyPoliceActivity : AppCompatActivity(R.layout.phone_privacy_police) {
    ...
    private fun openNext(){
        startActivity(Intent(this, PhoneFinishActivity::class.java))
    }
