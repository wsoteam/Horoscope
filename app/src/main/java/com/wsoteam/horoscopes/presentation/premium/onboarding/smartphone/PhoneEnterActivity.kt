package com.wsoteam.horoscopes.presentation.premium.onboarding.smartphone
...
import com.wsoteam.horoscopes.presentation.premium.onboarding.hair.HairAppsTermsActivity
import com.wsoteam.horoscopes.utils.InAppCallback
import com.wsoteam.horoscopes.utils.PreferencesProvider
import com.wsoteam.horoscopes.utils.SubscriptionProvider
import com.wsoteam.horoscopes.utils.analytics.Analytic
import com.wsoteam.horoscopes.utils.analytics.FBAnalytic
import kotlinx.android.synthetic.main.phone_enter_activity.*

class PhoneEnterActivity : AppCompatActivity(R.layout.phone_enter_activity) {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnPay.setOnClickListener { _ ->
            SubscriptionProvider.startChoiseSub(this, SubsIds.PHONE, object :
                InAppCallback {
    ...
    private fun openNext(){
        startActivity(Intent(this, PhoneAppsTermsActivity::class.java))
    }
