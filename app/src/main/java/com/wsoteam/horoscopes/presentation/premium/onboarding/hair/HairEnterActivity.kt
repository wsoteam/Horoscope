...
import com.wsoteam.horoscopes.presentation.premium.onboarding.girl.GirlAppsTermsActivity
import com.wsoteam.horoscopes.utils.InAppCallback
import com.wsoteam.horoscopes.utils.PreferencesProvider
import com.wsoteam.horoscopes.utils.SubscriptionProvider
import com.wsoteam.horoscopes.utils.analytics.Analytic
import com.wsoteam.horoscopes.utils.analytics.FBAnalytic
import kotlinx.android.synthetic.main.hair_enter_activity.*

class HairEnterActivity : AppCompatActivity(R.layout.hair_enter_activity) {
    ...
    private fun openNext(){
        startActivity(Intent(this, HairAppsTermsActivity::class.java))
    }
